...
export const getColumns = (
...
): ColumnDef<Order>[] => [
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("so_thu_tu")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("don_hang_id")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("ho_ten_khach_hang")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("so_dien_thoai")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("ten_pham_nhan")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="text-left">{row.getValue("tong_tien")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      let badgeVariant: "pending" | "paid" | "inactive" | "default" = "default";

      if (rawStatus === "Chờ thanh toán") badgeVariant = "pending";
      else if (rawStatus === "Đã thanh toán") badgeVariant = "paid";
      else if (rawStatus === "Đã hủy") badgeVariant = "inactive";
